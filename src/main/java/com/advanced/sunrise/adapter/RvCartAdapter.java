...
public class RvCartAdapter extends RecyclerView.Adapter<RvCartAdapter.RvCartHolder> {
    ...
    public RvCartAdapter(ArrayList<CartItem> cartItem, String st_disc, OnNotifyListener listener) {
    ...
    public void onBindViewHolder(RvCartHolder holder, final int position) {
        ...
        holder.tvUnitPrice.setText(getAmount(netPrice + cartItem.getProductDiscount()));
...
//        LayoutInflater inflater = getLayoutInflater();
        ...
        etQuantity.setText(String.valueOf((int) cart.getTypeQuantity()));
        ...
        ibQuantityDown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (previousSize > 1) {
                        previousSize--;
                        etQuantity.setText(String.valueOf((int) previousSize));
                    }
...
//                    haris added on 15-09-2020
                    if (quantity_flag == 0) {
                        etQuantity.setText(String.valueOf((int) nextSize));
                    }
...
//                        }
                    ...
                    myDatabase.update_productvat_byprodid(cart.getProductId(),cart.getTaxValue(),quantity);
...
//        }
//                Log.e("netprcee",""+cartItem.getNetPrice());
//                Log.e("qnty",""+cartItem.getTypeQuantity());
//                Log.e("hrct",""+cartItem.getWithouttaxTotal());
//                cartItem.setWithouttaxTotal(netPrice*cartItem.getTypeQuantity());
...
//    }
    ...
    public double getWithoutTaxTotal() {
        ...
        for (CartItem cartItem : cartItems) {
            ...
            Log.e("getNetPrice", "" + cartItem.getNetPrice());
            //  double d = cartItem.getNetPrice() * cartItem.getPieceQuantity();
