            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if (response.getString("status").equalsIgnoreCase("Success")) {
                                ...
                                if(sale.getInvoiceCode().equals(st_invoicecode)){
                                    if(sale.getCustomerId()==cust_id){
                                        if(sale_total == sale.getWithTaxTotal()) {
                                            ...
                                            Toast.makeText(context, "Dayclose Once more... " , Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
                        ...
                        Toast.makeText(context, "Getregisteredapis " + response.getString("status"), Toast.LENGTH_SHORT).show();
