...
public class Edit_ReturnqtyAdapter extends RecyclerView.Adapter<Edit_ReturnqtyAdapter.RvHolder> {
    private Context context;

    private String TAG = "Edit_ReturnqtyAdapter";
    ...
    public Edit_ReturnqtyAdapter(ArrayList<Size_Return> size_arrayfull1, OnNotifyListener listener) {
    ...
    @Override
    public Edit_ReturnqtyAdapter.RvHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sale_edit, parent, false);

        this.context = parent.getContext();

        return new Edit_ReturnqtyAdapter.RvHolder(view);
    }

    @Override
    public void onBindViewHolder(final Edit_ReturnqtyAdapter.RvHolder holder, final int position) {
