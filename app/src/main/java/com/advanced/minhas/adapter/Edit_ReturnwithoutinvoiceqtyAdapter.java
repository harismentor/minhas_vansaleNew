...
public class Edit_ReturnwithoutinvoiceqtyAdapter extends RecyclerView.Adapter<Edit_ReturnwithoutinvoiceqtyAdapter.RvHolder> {
    private Context context;

    private String TAG = "Edit_ReturnwithoutinvoiceqtyAdapter";

    String st_each_sizeqty="";
    private ArrayList<Size_Return> size_array_afteredit = new ArrayList<>();
    ...
    public Edit_ReturnwithoutinvoiceqtyAdapter(ArrayList<Size_Return> size_arrayfull1, OnNotifyListener listener) {
    ...
    @Override
    public Edit_ReturnwithoutinvoiceqtyAdapter.RvHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sale_edit, parent, false);

        this.context = parent.getContext();

        return new Edit_ReturnwithoutinvoiceqtyAdapter.RvHolder(view);
    }
    @Override
    public void onBindViewHolder(final Edit_ReturnwithoutinvoiceqtyAdapter.RvHolder holder, final int position) {

        final Size_Return s = size_arrayfull.get(position);

        holder.tv_size.setText(""+s.getReturn_size());

//        Log.e("getSize_stock",""+s.getReturn_size());
...
//        Log.e("tv_availableqty",""+s.getSize_stock());
        ...
        holder.bt_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if(nextSize<=Float.parseFloat(s.getReturn_qnty())) {
    ...
    public ArrayList<Size_Return> get_sizequantity_array(){
