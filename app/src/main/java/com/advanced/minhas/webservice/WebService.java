...
//haris added on 07-12-2020
    ...
    /**
     * Get Registered apis Web Server using Volley
     */
    public static void webRegisteredinvoices(final webObjectCallback callback, JSONObject object) {

        final String REQ_TAG = "volley_registered_api_tag";

        JsonObjectRequest registeredapiRequest = new JsonObjectRequest(Request.Method.POST, ConfigURL.URL_REGISTERED_INVOICES, object, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
        ...
        // Adding request to request queue
        ApplicationController.getInstance().addToRequestQueue(registeredapiRequest, REQ_TAG);
